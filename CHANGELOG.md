...
* resource/project_user, resource/project_role, and resource/project_repository are migrated to Plugin Framework. PR: [#132](https://github.com/jfrog/terraform-provider-project/pull/132)
